...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, TFT_RES_Pin|TFT_DC_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TFT_BL_GPIO_Port, TFT_BL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI2CS_Pin|I2C_Pin|I2CB7_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PE3 PEPin PEPin
                           PEPin */
  GPIO_InitStruct.Pin = FIVE_Pin|GPIO_PIN_3|FIVEE4_Pin|FIVEE5_Pin
                          |FIVEE6_Pin;
  ...
  GPIO_InitStruct.Pin = SPI2CS_Pin|I2C_Pin|I2CB7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
