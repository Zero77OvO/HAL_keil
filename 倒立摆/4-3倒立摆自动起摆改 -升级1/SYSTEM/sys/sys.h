...
extern int adcc0;//oled比较角速度

extern u8 auto_run; //手动起摆或自动起摆标志位，默认是手动起摆
extern u8 autorun_step0; //自动起摆第0步，找到中点，等待起摆
extern u8 autorun_step1; //自动起摆第1步
extern u8 autorun_step2; //自动起摆第2步
#endif
