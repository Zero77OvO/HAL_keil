...
void add_point(int new_x, int new_y) {
    ...
    if (num_points > 0) {
        ...
        if (fabs(new_x - last_x) < 3 && fabs(new_y - last_y) < 3) {
		...
		if(dma_flag==0)	{
			...
			if(RxState1_1 ==0&&USART1_NewData_1==0x1A){
				...
				if(USART1_RX_BUF_1[USART1_RX_STA_1-1]== 0x3C){
						...
						x1 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-9]+10;
						y1 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-8];
						x2 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-7]+10;
						y2 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-6];
						x3 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-5]+10;
						y3 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-4];
						x4 = (float) USART1_RX_BUF_1[USART1_RX_STA_1-3]+10;
